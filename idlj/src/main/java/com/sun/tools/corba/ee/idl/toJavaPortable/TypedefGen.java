 ...
 *
 **/
public class TypedefGen implements com.sun.tools.corba.ee.idl.TypedefGen, com.sun.tools.corba.ee.idl.toJavaPortable.JavaGenerator
{
  /**
  ...
  {
    ((Factories) com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.factories ()).holder ().generate (symbolTable, t);
  }
  ...
  {
    ((Factories) com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.factories ()).helper ().generate (symbolTable, t);
  }
  ...
  public int helperType (int index, String indent, com.sun.tools.corba.ee.idl.toJavaPortable.TCOffsets tcoffsets, String name, SymtabEntry entry, PrintWriter stream)
  {
    ...
    {
      String size = com.sun.tools.corba.ee.idl.toJavaPortable.Util.parseExpression((Expression) td.arrayInfo().elementAt(i));
    ...
    if (!inStruct)
      ...
      stream.println (indent + name + " = org.omg.CORBA.ORB.init ().create_alias_tc (" + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(td, true) + ".id (), \"" + com.sun.tools.corba.ee.idl.toJavaPortable.Util.stripLeadingUnderscores(td.name()) + "\", " + name + ");"); // <d61056>
  ...
  {
    TypedefEntry td = (TypedefEntry)entry;
    String modifier = com.sun.tools.corba.ee.idl.toJavaPortable.Util.arrayInfo(td.arrayInfo());
    if (!modifier.equals (""))
    {
      ...
      try
      {
        baseName = (String)td.dynamicVariable (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.typedefInfo);
      }
      ...
      String arrayDcl = com.sun.tools.corba.ee.idl.toJavaPortable.Util.sansArrayInfo(baseName.substring(startArray)) + "[]"; // Add an extra set because the first gets stripped off in the loop.
      ...
      if (td.type () instanceof SequenceEntry || td.type () instanceof PrimitiveEntry || td.type () instanceof StringEntry)
        index = ((com.sun.tools.corba.ee.idl.toJavaPortable.JavaGenerator)td.type ().generator ()).read (index, indent, name, td.type (), stream);
        ...
        stream.println (indent + name + " = " + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(td.type(), true) + ".read (istream);"); // <d61056>
    ...
    {
      SymtabEntry tdtype = com.sun.tools.corba.ee.idl.toJavaPortable.Util.typeOf(td.type());
      if (tdtype instanceof SequenceEntry || tdtype instanceof PrimitiveEntry || tdtype instanceof StringEntry)
        index = ((com.sun.tools.corba.ee.idl.toJavaPortable.JavaGenerator)tdtype.generator ()).read (index, indent, name, tdtype, stream);
      else if (tdtype instanceof InterfaceEntry && tdtype.fullName ().equals ("org/omg/CORBA/Object"))
        stream.println (indent + name + " = istream.read_Object ();");
      else
        stream.println (indent + name + " = " + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(tdtype, true) + ".read (istream);"); // <d61056>
    }
    return index;
  } // read
  ...
  public int write (int index, String indent, String name, SymtabEntry entry, PrintWriter stream)
  {
    ...
    if (!modifier.equals (""))
    {
      ...
      if (td.type () instanceof SequenceEntry || td.type () instanceof PrimitiveEntry || td.type () instanceof StringEntry)
        index = ((com.sun.tools.corba.ee.idl.toJavaPortable.JavaGenerator)td.type ().generator ()).write (index, indent, name, td.type (), stream);
      else if (td.type () instanceof InterfaceEntry && td.type ().fullName ().equals ("org/omg/CORBA/Object"))
        stream.println (indent + "ostream.write_Object (" + name + ");");
      else
        stream.println (indent + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(td.type(), true) + ".write (ostream, " + name + ");"); // <d61056>
      for (int i = 0; i < closingBrackets; ++i)
      {
        indent = indent.substring (2);
        stream.println (indent + '}');
    ...
    else
    {
      SymtabEntry tdtype = com.sun.tools.corba.ee.idl.toJavaPortable.Util.typeOf(td.type());
      if (tdtype instanceof SequenceEntry || tdtype instanceof PrimitiveEntry || tdtype instanceof StringEntry)
        index = ((com.sun.tools.corba.ee.idl.toJavaPortable.JavaGenerator)tdtype.generator ()).write (index, indent, name, tdtype, stream);
      else if (tdtype instanceof InterfaceEntry && tdtype.fullName ().equals ("org/omg/CORBA/Object"))
        stream.println (indent + "ostream.write_Object (" + name + ");");
      else
        stream.println (indent + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(tdtype, true) + ".write (ostream, " + name + ");"); // <d61056>
    }
    return index;
  } // write
