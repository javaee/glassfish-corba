 ...
 **/
public class Util extends com.sun.tools.corba.ee.idl.Util
{
  // <d58319>
  /**
  ...
  {
    return com.sun.tools.corba.ee.idl.Util.getVersion("com/sun/tools/corba/ee/idl/toJavaPortable/toJavaPortable");
  } // getVersion
  ...
  {
    com.sun.tools.corba.ee.idl.toJavaPortable.NameModifier nm = new NameModifierImpl() ;
    return fileName( entry, nm, extension ) ;
  } // fileName

  public static String fileName (SymtabEntry entry, com.sun.tools.corba.ee.idl.toJavaPortable.NameModifier modifier, String extension )
  {
  ...
  public static GenFileStream stream (SymtabEntry entry, com.sun.tools.corba.ee.idl.toJavaPortable.NameModifier modifier, String extension )
  {
  ...
  {
    // <f46838.4>
    String absPathName = ((com.sun.tools.corba.ee.idl.toJavaPortable.Arguments) com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.arguments).targetDir + name;
    if (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.arguments.keepOldFiles && new File (absPathName).exists ())
      return null;
    else
  ...
  public static String javaName (SymtabEntry entry)
  {
    ...
    if (entry instanceof TypedefEntry || entry instanceof SequenceEntry)
      try
      {
        name = sansArrayInfo ((String)entry.dynamicVariable (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.typedefInfo));
      }
  ...
  static void fillInfo (SymtabEntry infoEntry)
  {
    ...
    do
    {
      try
      {
        alreadyHave = entry.dynamicVariable (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.typedefInfo) != null;
      }
      catch (NoSuchFieldException e)
      {}
      ...
      if (!alreadyHave)
      {
        ...
        {
          com.sun.tools.corba.ee.idl.constExpr.Expression maxSize = ((SequenceEntry)entry).maxSize ();
          if (maxSize == null)
            arrayInfo = arrayInfo + "[]";
          else
    ...
    {
      if (alreadyHave)
        infoEntry.dynamicVariable (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.typedefInfo, (String)entry.dynamicVariable (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.typedefInfo) + arrayInfo);
      else
        infoEntry.dynamicVariable (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.typedefInfo, javaName (entry) + arrayInfo);
    }
    catch (NoSuchFieldException e)
    {}
  } // fillInfo
  ...
  public static void writePackage (PrintWriter stream, SymtabEntry entry, String name, short type)
  {
    if (name != null && !name.equals (""))
    {
      ...
      // those types.
      if (!com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.importTypes.isEmpty ())
      {
        stream.println ();
        Vector v = addImportLines (entry, com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.importTypes, type);
  ...
  public static void writePackage (PrintWriter stream, SymtabEntry entry, short type)
  {
    ...
    if (fullName != null && !fullName.equals (""))
    {
      ...
      // in the unnamed module, add an import statement for each of
      // those types.
      if ((type != HolderFile || entry instanceof TypedefEntry) && !com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.importTypes.isEmpty ())
      {
        stream.println ();
        Vector v = addImportLines (entry, com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.importTypes, type);
        printImports (v, stream);
  ...
  static private Vector addImportLines (SymtabEntry entry, Vector importTypes, short type)
  {
    ...
    else if (entry instanceof TypedefEntry)
    {
      ...
      if (type == HelperFile)
      {
        ...
        try
        {
          String name = (String)t.dynamicVariable (com.sun.tools.corba.ee.idl.toJavaPortable.Compile.typedefInfo);
          int index = name.indexOf ('[');
          if (index >= 0)
            name = name.substring (0, index);
  ...
  {
    String targetDir = ((com.sun.tools.corba.ee.idl.toJavaPortable.Arguments) com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.arguments).targetDir; // F46838.4
  ...
  public static void writeProlog (PrintWriter stream, String filename)
  {
    ...
    String targetDir = ((com.sun.tools.corba.ee.idl.toJavaPortable.Arguments) com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.arguments).targetDir;
    if (targetDir != null)
   ...
   *
   **/
  public static String parseExpression (com.sun.tools.corba.ee.idl.constExpr.Expression e)
  {
    if (e instanceof com.sun.tools.corba.ee.idl.constExpr.Terminal)
      return parseTerminal ((com.sun.tools.corba.ee.idl.constExpr.Terminal)e);
    else if (e instanceof com.sun.tools.corba.ee.idl.constExpr.BinaryExpr)
      return parseBinary ((com.sun.tools.corba.ee.idl.constExpr.BinaryExpr)e);
    else if (e instanceof com.sun.tools.corba.ee.idl.constExpr.UnaryExpr)
      return parseUnary ((com.sun.tools.corba.ee.idl.constExpr.UnaryExpr)e);
    else
   ...
   *
   **/
  static String parseTerminal (com.sun.tools.corba.ee.idl.constExpr.Terminal e)
  {
    ...
    else if (e.value () instanceof com.sun.tools.corba.ee.idl.constExpr.Expression)
    ...
    */
    else if (e.value () instanceof BigInteger)
    {
      ...
      if (type.equals("unsigned long long") &&
          ((BigInteger)e.value ()).compareTo (com.sun.tools.corba.ee.idl.constExpr.Expression.llMax) > 0) // value > long long Max?
      {
        // Convert to signed value, which will always be negative.
        BigInteger v = (BigInteger)e.value ();
        v = v.subtract (com.sun.tools.corba.ee.idl.constExpr.Expression.twoPow64);
   ...
   *
   **/
  static String parseBinary (com.sun.tools.corba.ee.idl.constExpr.BinaryExpr e)
  {
    String castString = "";
    if (e.value () instanceof Float || e.value () instanceof Double)
    {
      castString = "(double)";
      if (!(e instanceof com.sun.tools.corba.ee.idl.constExpr.Plus || e instanceof com.sun.tools.corba.ee.idl.constExpr.Minus ||
            e instanceof com.sun.tools.corba.ee.idl.constExpr.Times || e instanceof com.sun.tools.corba.ee.idl.constExpr.Divide))
    ...
    if (e.type ().equals ("unsigned long long"))
    {
      ...
      if (value.compareTo (com.sun.tools.corba.ee.idl.constExpr.Expression.llMax) > 0) // value > long long max?
        value = value.subtract (com.sun.tools.corba.ee.idl.constExpr.Expression.twoPow64); // Convert to Java long (signed)
   ...
   *
   **/
  static String parseUnary (com.sun.tools.corba.ee.idl.constExpr.UnaryExpr e)
  {
    ...
    else if ((e.value () instanceof Float || e.value () instanceof Double) && e instanceof com.sun.tools.corba.ee.idl.constExpr.Not)
      return "(UNKNOWN_VALUE)"; // This shouldn't happen if the parser checked the expression types correctly.
    else
    {
      String castString = "";
  ...
  {
    float level = com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.arguments.corbaLevel;
    float delta = 0.001f;
