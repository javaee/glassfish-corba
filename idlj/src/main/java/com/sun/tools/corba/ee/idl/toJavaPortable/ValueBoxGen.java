...
//  writeStreamableMethods ();
  ...
  //                put real marshalling code in read_value.
    ...
    if (mType instanceof PrimitiveEntry ||
      ...
      stream.println (indent + com.sun.tools.corba.ee.idl.toJavaPortable.Util.javaQualifiedName(mType) + " tmp = (" +
                      com.sun.tools.corba.ee.idl.toJavaPortable.Util.javaQualifiedName(mType) + ") ((org.omg.CORBA_2_3.portable.InputStream)istream).read_value (" + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(mType, true) + ".get_instance ());"); // <d60929> // <d61056>
    else
  ...
  protected void streamableRead (String entryName, SymtabEntry entry, PrintWriter stream)
  {
        ...
        mType instanceof StringEntry || !member.arrayInfo ().isEmpty ())
    {
      ...
      stream.println ("    " + entryName + ".value = (" + com.sun.tools.corba.ee.idl.toJavaPortable.Util.javaQualifiedName(mType) + ") ((org.omg.CORBA_2_3.portable.InputStream)istream).read_value (" + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(mType, true) + ".get_instance ());"); // <d60929> // <d61056>
    else
