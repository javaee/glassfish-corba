...
public class ValueGen implements com.sun.tools.corba.ee.idl.ValueGen, com.sun.tools.corba.ee.idl.toJavaPortable.JavaGenerator
{
  ...
  protected void generateTie ()
  {
    ...
    {
      com.sun.tools.corba.ee.idl.toJavaPortable.Factories factories = (com.sun.tools.corba.ee.idl.toJavaPortable.Factories) com.sun.tools.corba.ee.idl.toJavaPortable.Compile.compiler.factories ();
...
//  <d59418> Custom valuetypes implement org.omg.CORBA.CustomMarshal.
    ...
    for (int k = 0; k < noOfMembers; k++)
    {
      ...
      else if (mType instanceof ValueEntry)
      {
        ...
        stream.println ("    " + name + '.' + memberName + " = (" + returnType +
                        ") ((org.omg.CORBA_2_3.portable.InputStream)istream).read_value (" + com.sun.tools.corba.ee.idl.toJavaPortable.Util.helperName(mType, true) +  // <d61056>
                        ".get_instance ());"); // <d61056>
      }
      else
  ...
  public void helperWrite (SymtabEntry entry, PrintWriter stream)
  {
    ...
    if (!((ValueEntry)entry).isCustom ())
    {
       stream.println ("  public static void _write (org.omg.CORBA.portable.OutputStream ostream, " + com.sun.tools.corba.ee.idl.toJavaPortable.Util.javaName(entry) + " value)");
       stream.println ("  {");
