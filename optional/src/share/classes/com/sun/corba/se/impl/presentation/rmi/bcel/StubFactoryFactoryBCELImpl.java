...
public class StubFactoryFactoryBCELImpl extends StubFactoryFactoryDynamicBase 
{
    public StubFactoryFactoryBCELImpl()
    {
	super() ;
    }
    ...
    {
	return new StubFactoryBCELImpl( pm, classData, classLoader ) ;
    }
}
