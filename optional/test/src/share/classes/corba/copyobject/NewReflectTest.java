...
import com.sun.corba.se.spi.copyobject.OptimizedCopyobjectDefaults ;
...
public class NewReflectTest extends Client
{
    ...
    { 
	System.out.println( ORBConstants.USE_BCEL_REFLECTIVE_COPYOBJECT + "=" +
	    System.getProperty( ORBConstants.USE_BCEL_REFLECTIVE_COPYOBJECT ) ) ;
    }
    ...
    {
	return OptimizedCopyobjectDefaults.makeReflectObjectCopierFactory( orb ) ;
    }
