...
import com.sun.corba.se.impl.presentation.rmi.bcel.ProxyClassCreator ;

/** Test for the BCEL-based ProxyCreator.  
 * Steps to test:
 * <OL>
 ...
 * This looks a lot like BCELStubBase but does not extend Stub.
 ...
 * <OL>
 */
public class TestBCELProxyCreator extends TestCase {
    ...
    {
	return new TestSuite( TestBCELProxyCreator.class ) ;
    }
}
