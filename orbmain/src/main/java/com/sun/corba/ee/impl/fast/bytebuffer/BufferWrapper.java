 ...
 * holder.
 */
package com.sun.corba.ee.impl.fast.bytebuffer ;
...
public class BufferWrapper {
    ...
    private Slab slab ;
    private int slabPosition ; // starting position in the Slab before this BufferWrapper was allocated.
    ...
    public void trim() {
        checkDispose() ;
        int sizeNeeded = headerSize + visible.position() ;
