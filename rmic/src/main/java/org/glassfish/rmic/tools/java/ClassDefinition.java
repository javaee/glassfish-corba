/*
 * Copyright (c) 1994, 2015, 2018, Oracle and/or its affiliates. All rights reserved.
...
public abstract class ClassDefinition implements Constants {
    ...
    // *** DEBUG ***
    protected boolean supersCheckStarted = !(this instanceof org.glassfish.rmic.tools.javac.SourceClass);
   ...
   /**
                ...
                if (override != null) {
                    ...
                    if (formerMethod == null) {
                        ...
                        if (mirandaMethods != null &&
                            ...
                            // VM.
                            method =
                                new org.glassfish.rmic.tools.javac.SourceMember(method,this,
                                                                 env);
                        ...
                        if (method.couldOverride(env, formerMethod)) {
                            ...
                            if (mirandaMethods != null &&
                                ...
                                // VM.
                                method =
                                    new org.glassfish.rmic.tools.javac.SourceMember(method,
                                                                     this,env);
     ...
     * @see org.glassfish.rmic.tools.javac.SourceClass#resolveTypeStructure
     */
