...
public class _ServerInvokerServantPOA_Tie extends Servant implements Tie {
    
    volatile private ServerInvokerServantPOA target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (ServerInvokerServantPOA) target;
    }
    ...
    public OutputStream  _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ServerInvokerServantPOA target = this.target;
            if (target == null) {
