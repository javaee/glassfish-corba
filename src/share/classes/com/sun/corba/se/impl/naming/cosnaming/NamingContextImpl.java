    ...
    implements NamingContextDataStore
{
    ...
    private static NamingSystemException staticWrapper = ORB.getStaticLogWrapperTable()
	.get_NAMING_UPDATE_Naming() ;
	...
	super();
	this.orb = orb;
	wrapper =  orb.getLogWrapperTable().get_NAMING_UPDATE_Naming() ;

        insImpl = new InterOperableNamingImpl( );
        this.nsPOA = poa;
        readLogger = ORB.getLogger( 
	    LogWrapperName.getLoggerName( orb, 
		CORBALogDomains.NAMING_READ));
        updateLogger = ORB.getLogger( 
	    LogWrapperName.getLoggerName( orb, 
