...
("com.sun.corba.se.impl.logging" "OMGSystemException" OMG
	...
	(BAD_PARAM
	    ...
	    (SO_BAD_SCHEME_NAME		    7  FINE "string_to_object conversion failed due to bad scheme name")
	    (SO_BAD_ADDRESS		    8  FINE "string_to_object conversion failed due to bad address")
	    (SO_BAD_SCHEMA_SPECIFIC	    9  FINE "string_to_object conversion failed due to bad bad schema specific part")
