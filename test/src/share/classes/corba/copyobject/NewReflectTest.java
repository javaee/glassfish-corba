...
public class NewReflectTest extends Client
{
    ...
    { 
	System.out.println( ORBConstants.USE_CODEGEN_REFLECTIVE_COPYOBJECT + "=" +
	    System.getProperty( ORBConstants.USE_CODEGEN_REFLECTIVE_COPYOBJECT ) ) ;
    }
    ...
    {
	return CopyobjectDefaults.makeReflectObjectCopierFactory( orb ) ;
    }
