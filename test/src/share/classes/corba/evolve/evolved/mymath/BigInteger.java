 ...
 * 09297   150201 hdrs    ScJVM: Make statics final
 * 32303   160501 hdpsm   Replace writeReplace with writeObject to avoid 
 *                        NullPointerException when BigInteger is deserialized
 * 54934   170902 vkumara SUNREG:test/mymath/BigInteger/StringConstructor.java
 *                        throwing RuntimeException
 * 78006   130904 stalleyj Merge to 5.0
 *
 * ===========================================================================
 * Module Information:
 *
...
public class BigInteger extends Number implements Comparable<BigInteger> {
	...
	String group = val.substring(cursor, cursor += firstGroupLen);
        ...
        if (mag[mag.length - 1] < 0) {                          /*ibm@54934*/
            throw new NumberFormatException("Illegal Digit");   /*ibm@54934*/
        }                                                       /*ibm@54934*/
    ...
    // Certainly required to meet the spec of probablePrime
    ...
    */
    ...
    static final int[] bnExpModThreshTable = {7, 25, 81, 241, 673, 1793,
