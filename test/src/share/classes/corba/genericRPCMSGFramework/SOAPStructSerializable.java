 ...
 * holder.
 */
// Identical to SOAPStruct except Serializable.
...
public final class SOAPStructSerializable implements java.io.Serializable {
    private float varFloat;
    private int varInt;
    private java.lang.String varString;
    
    public SOAPStructSerializable() {
    }
    
    public SOAPStructSerializable(float varFloat, int varInt, java.lang.String varString) {
