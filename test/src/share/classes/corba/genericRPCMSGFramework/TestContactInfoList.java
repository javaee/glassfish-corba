 ...
 * @author Harold Carr
 */
public class TestContactInfoList
    implements
	ContactInfoList,
	ContactInfoListIterator
{
    ...
    public TestContactInfoList(ORB corbaBroker,
    ...
    ////////////////////////////////////////////////////
    //
    // framework.transport.ContactInfoList
    //
    ...
    ////////////////////////////////////////////////////
    //
    // framework.transport.ContactInfoListIterator
    //
    ...
    public Object next()
    {
	ContactInfo result = contactInfoList[next];
	next = (next + 1) % contactInfoList.length;
	return result;	
    }
