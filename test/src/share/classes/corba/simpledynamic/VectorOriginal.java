    ...
    implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     *         is negative
     */
    public VectorOriginal(int initialCapacity, int capacityIncrement) {
	super();
     ...
     *         is negative
     */
    public VectorOriginal(int initialCapacity) {
     ...
     * @since   1.2
     */
    public VectorOriginal(Collection<? extends E> c) {
	...
	return new Enumeration<E>() {
		...
		synchronized (VectorOriginal.this) {
	...
	try {
	    VectorOriginal<E> v = (VectorOriginal<E>) super.clone();
