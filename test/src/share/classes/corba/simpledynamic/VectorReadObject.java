 ...
 * @since   JDK1.0
 */
public class VectorReadObject<E>
    ...
    implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     *         is negative
     */
    public VectorReadObject(int initialCapacity, int capacityIncrement) {
	super();
     ...
     *         is negative
     */
    public VectorReadObject(int initialCapacity) {
     ...
     * @since   1.2
     */
    public VectorReadObject(Collection<? extends E> c) {
	...
	return new Enumeration<E>() {
		...
		synchronized (VectorReadObject.this) {
	...
	try {
	    VectorReadObject<E> v = (VectorReadObject<E>) super.clone();
