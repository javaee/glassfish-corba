...
public class TimerPointsSuite {
	...
	// We should be running this test from the test/make directory.
	String fileName = "../src/share/classes/corba/timer/timing.xml" ;
	...
	try {
	    ...
	    TimerPointSourceGenerator.generateSourceFiles( "gen", result ) ;
